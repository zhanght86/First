 ...
 */
@Entity
@Table(name = "CfReportDataCheck")
public class CfReportDataCheck {
	...
	private BigDecimal tolerance;  //容差    //容差      add by liucw
	
	public CfReportDataCheck() {
	}

	public CfReportDataCheck(int serialNo, String calFormula) {
