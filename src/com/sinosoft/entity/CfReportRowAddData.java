 ...
 */
@Entity
@Table(name = "CfReportRowAddData")
public class CfReportRowAddData implements java.io.Serializable {

	private CfReportRowAddDataId id;
	...
	public CfReportRowAddData() {
	}

	public CfReportRowAddData(CfReportRowAddDataId id, String colType,
	...
	public CfReportRowAddData(CfReportRowAddDataId id, String tableCode, String yearMonth, String quarter, String reportRate, String comCode,
	...
	public CfReportRowAddDataId getId() {
		return this.id;
	}

	public void setId(CfReportRowAddDataId id) {
		this.id = id;
	}
