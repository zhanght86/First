...
@Entity
@Table(name="His_Cux_Interface_Valuation")
public class His_Cux_Interface_Valuation {
	 @EmbeddedId
	  @AttributeOverrides({
			...
			@AttributeOverride(name = "datadate", column = @Column(name = "datadate", nullable = false, length = 100)), 
			@AttributeOverride(name = "status", column = @Column(name = "status", nullable = false, length = 6)) 

	  })
	  private His_Cux_Interface_ValuationId id;
	  @Column
	...
	public His_Cux_Interface_ValuationId getId() {
		return id;
	}
	public void setId(His_Cux_Interface_ValuationId id) {
		this.id = id;
	}
	...
	public void setMarketValueForAccountPersent(
			BigDecimal marketValueForAccountPersent) {
