 ...
 */
@Entity
@Table(name = "CfReportItemCodeDesc")
public class CfReportItemCodeDesc implements java.io.Serializable {
	...
	public CfReportItemCodeDesc() {
	}

	public CfReportItemCodeDesc(String reportItemCode) {
		this.reportItemCode = reportItemCode;
	}

	public CfReportItemCodeDesc(String reportItemCode, String reportItemName,
			...
			String temp2, String temp3, String reportItemDescForYear) {
		this.reportItemCode = reportItemCode;
