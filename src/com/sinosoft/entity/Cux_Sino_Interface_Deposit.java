...
/**
 * Cux_Sino_Interface_Deposit generated by hbm2java
 */
@Entity
@Table(name = "Cux_Sino_Interface_Deposit")
public class Cux_Sino_Interface_Deposit {
	@EmbeddedId
	@AttributeOverrides({
	...
	private Cux_Sino_Interface_DepositId id;
	@Column
	...
	public Cux_Sino_Interface_DepositId getId() {
		return id;
	}
	public void setId(Cux_Sino_Interface_DepositId id) {
		this.id = id;
	}
