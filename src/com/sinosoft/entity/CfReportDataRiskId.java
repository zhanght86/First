 ...
 */
@Embeddable
public class CfReportDataRiskId implements java.io.Serializable {
	private String reportId;
	private String outItemCode;

	public CfReportDataRiskId() {
	}

	public CfReportDataRiskId(String outItemCode, String reportId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CfReportDataRiskId))
			return false;
		CfReportDataRiskId castOther = (CfReportDataRiskId) other;
