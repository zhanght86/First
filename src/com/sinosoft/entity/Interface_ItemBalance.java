...
@Entity
@Table(name="Interface_ItemBalance")
public class Interface_ItemBalance implements java.io.Serializable {
	
	@EmbeddedId
	@AttributeOverrides({
		@AttributeOverride(name = "yearmonth", column = @Column(name="quarter",nullable = false, length = 20)),
	...
	private Interface_ItemBalanceId id;
	...
	public Interface_ItemBalanceId getId() {
		return id;
	}

	public void setId(Interface_ItemBalanceId id) {
		this.id = id;
	}
