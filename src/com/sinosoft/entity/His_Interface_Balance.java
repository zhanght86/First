...
@Entity
@Table(name="His_Interface_Balance")
public class His_Interface_Balance implements java.io.Serializable{
	...
	private His_Interface_BalanceId id;
	@Column
	...
	public His_Interface_BalanceId getId() {
		return id;
	}
	public void setId(His_Interface_BalanceId id) {
		this.id = id;
	}
