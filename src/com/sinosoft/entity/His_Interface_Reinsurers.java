...
@Entity
@Table(name="His_Interface_Reinsurers")
public class His_Interface_Reinsurers {
	@EmbeddedId
	@AttributeOverrides({
	...
	private His_Interface_ReinsurersId id;
	...
	public His_Interface_ReinsurersId getId() {
		return id;
	}
	public void setId(His_Interface_ReinsurersId id) {
		this.id = id;
	}
