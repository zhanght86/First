 ...
 */
@Entity
@Table(name = "rsys_CfReportRowAddDesc")
public class OCfReportRowAddDesc implements java.io.Serializable {

	private OCfReportRowAddDescId id;
	...
	public OCfReportRowAddDesc() {
	}

	public OCfReportRowAddDesc(OCfReportRowAddDescId id) {
		this.id = id;
	}

	public OCfReportRowAddDesc(OCfReportRowAddDescId id, String tableName,
	...
	public OCfReportRowAddDescId getId() {
		return this.id;
	}

	public void setId(OCfReportRowAddDescId id) {
		this.id = id;
	}
