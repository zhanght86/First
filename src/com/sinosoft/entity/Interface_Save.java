...
@Entity
@Table(name="Interface_Save")
public class Interface_Save implements java.io.Serializable{
	...
	public Interface_SaveId getId() {
		return id;
	}
	public void setId(Interface_SaveId id) {
		this.id = id;
	}
