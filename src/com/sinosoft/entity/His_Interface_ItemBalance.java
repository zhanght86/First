...
@Entity
@Table(name="His_Interface_ItemBalance")
public class His_Interface_ItemBalance {
	@EmbeddedId
	@AttributeOverrides({
	...
	private His_Interface_ItemBalanceId id;
	...
	public His_Interface_ItemBalanceId getId() {
		return id;
	}

	public void setId(His_Interface_ItemBalanceId id) {
		this.id = id;
	}
