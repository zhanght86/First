...
/**
 * Cux_Sino_Interface_HS300Stock generated by hbm2java
 */
@Entity
@Table(name = "Cux_Sino_Interface_HS300Stock")
public class Cux_Sino_Interface_HS300Stock {
	@EmbeddedId
	@AttributeOverrides({
	...
	private Cux_Sino_Interface_HS300StockId id;
	...
	public Cux_Sino_Interface_HS300StockId getId() {
		return id;
	}
	public void setId(Cux_Sino_Interface_HS300StockId id) {
		this.id = id;
	}
