...
@Entity
@Table(name="Interface_Propolicyloans")
public class Interface_Propolicyloans {
	@EmbeddedId
	@AttributeOverrides({
	...
	private Interface_PropolicyloansId id;
	...
	public Interface_PropolicyloansId getId() {
		return id;
	}
	public void setId(Interface_PropolicyloansId id) {
		this.id = id;
	}
