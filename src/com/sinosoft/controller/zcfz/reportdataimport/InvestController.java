...
@Controller
@RequestMapping(path="/invest")
public class InvestController {
	//投资数据模板 下载
		@RequestMapping(path="/model",method=RequestMethod.POST)
	    public  void  investModel(HttpServletRequest request,HttpServletResponse response,UploadFile uf) throws IOException{
	    	uf.setFileName("投资数据模板.xlsm");
