 ...
 */
@Embeddable
public class ALM_CfReportDataId implements java.io.Serializable {
	private String reportId;
	private String outItemCode;

	public ALM_CfReportDataId() {
	}

	public ALM_CfReportDataId(String outItemCode, String reportId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ALM_CfReportDataId))
			return false;
		ALM_CfReportDataId castOther = (ALM_CfReportDataId) other;
