 ...
 */
@Entity
@Table(name = "ALM_CfReportData")
public class ALM_CfReportData implements java.io.Serializable {
	private ALM_CfReportDataId id;
	...
	public ALM_CfReportData() {
	}

	public ALM_CfReportData(ALM_CfReportDataId id, String computeLevel,
	...
	public ALM_CfReportData(ALM_CfReportDataId id, String comCode, String outItemType,
	...
	public ALM_CfReportDataId getId() {
		return this.id;
	}

	public void setId(ALM_CfReportDataId id) {
		this.id = id;
	}
