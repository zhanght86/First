 ...
 */
@Entity
@Table(name = "ALM_CfReportRowAddDesc")
public class ALM_CfReportRowAddDesc implements java.io.Serializable {

	private ALM_CfReportRowAddDescId id;
	...
	public ALM_CfReportRowAddDesc() {
	}

	public ALM_CfReportRowAddDesc(ALM_CfReportRowAddDescId id) {
		this.id = id;
	}

	public ALM_CfReportRowAddDesc(ALM_CfReportRowAddDescId id, String tableName,
	...
	public ALM_CfReportRowAddDescId getId() {
		return this.id;
	}

	public void setId(ALM_CfReportRowAddDescId id) {
		this.id = id;
	}
