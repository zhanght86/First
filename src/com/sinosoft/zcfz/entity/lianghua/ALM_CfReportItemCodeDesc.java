 ...
 */
@Entity
@Table(name = "ALM_CfReportItemCodeDesc")
public class ALM_CfReportItemCodeDesc implements java.io.Serializable {
	...
	public ALM_CfReportItemCodeDesc() {
	}

	public ALM_CfReportItemCodeDesc(String reportItemCode) {
	...
	public ALM_CfReportItemCodeDesc(String reportItemCode, String reportItemName,
			...
			String temp2, String temp3, String reportItemDescForYear, String sheetRow ,String sheetCell) {
		this.reportItemCode = reportItemCode;
