...
@Entity
public class Alm_ComputeResult implements Serializable{
	
	@EmbeddedId
	private Alm_ComputeResultId  id;
	@Column
	...
	public Alm_ComputeResultId getId() {
		return id;
	}
	public void setId(Alm_ComputeResultId id) {
		this.id = id;
	}
