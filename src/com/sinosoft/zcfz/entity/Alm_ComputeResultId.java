...
@Embeddable
public class Alm_ComputeResultId implements Serializable {

	private String reportId;
	
	private String itemCode;
	
	public Alm_ComputeResultId() {
		
	}
	public Alm_ComputeResultId(String reportId, String itemCode) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Alm_ComputeResultId))
			return false;
		Alm_ComputeResultId castOther = (Alm_ComputeResultId) other;
