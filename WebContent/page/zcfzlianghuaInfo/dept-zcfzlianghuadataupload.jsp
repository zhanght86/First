...
<div class="easyui-panel" style="height: auto; width:100%; padding: 8px 0px 0px 0px;overflow: hidden;">
 ...
 <div class="easyui-panel" style="border: 0;width: 100%">
		<table id="dgs" class="easyui-datagrid"
			...
			>
			<div id="toolbar">
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="modedownload('1')" plain="true" data-options="iconCls:'icon-print'" style="width:140px;">部门模板下载</a>
	    		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="modedownload('1-data')" plain="true" data-options="iconCls:'icon-print'" style="width:150px;">部门数据下载</a>
