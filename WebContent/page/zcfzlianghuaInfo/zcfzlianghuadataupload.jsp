...
<div class="easyui-panel" style="height: auto; width:100%; padding: 8px 0px 0px 0px;overflow: hidden;">
		<input editable="false" style="display:none" name="deptflag" value="no">
 ...
 <div class="easyui-panel" style="border: 0;width: 100%">
		<table id="dgs" class="easyui-datagrid"
			...
			>
			<div id="toolbar">
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="modedownload('all')" plain="true" data-options="iconCls:'icon-print'" style="width:120px;">完整模板下载</a>
	    		<!-- <a href="javascript:void(0)" class="easyui-linkbutton" onclick="modedownload('1')" plain="true" data-options="iconCls:'icon-print'" style="width:140px;">法人机构模板下载</a>
	    		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="modedownload('2')" plain="true" data-options="iconCls:'icon-print'" style="width:140px;">分支机构模板下载</a> -->
	    		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="modedownload('1-data')" plain="true" data-options="iconCls:'icon-print'" style="width:150px;">完整数据下载</a>
	    		<!-- <a href="javascript:void(0)" class="easyui-linkbutton" onclick="modedownload('2-data')" plain="true" data-options="iconCls:'icon-print'" style="width:150px;">分支机构数据下载</a> -->
	    		...
	    		<!-- <a href="javascript:void(0)" class="easyui-linkbutton" onclick="reset()" plain="true" data-options="iconCls:'icon-reload'" style="width:80px;">重置</a> -->
			</div>
			<thead>
				<tr>
					...
					<th field="quarter" width="23%" align="center" halign="center" hidden>报送季度</th>
					<th field="quarterName" width="12%" align="center" halign="center" >报送季度</th>
					<th field="reportType" width="23%" align="center" halign="center" hidden>报送类型</th>
   ...
   <div id="dlg2" class="easyui-dialog" style="width:850px;height:450px;"
    ...
    <div id="dlg-buttons">
    	...
    	<a href="javascript:void(0)" class="easyui-linkbutton"  data-options="iconCls:'icon-print'" onclick="exportXls('dg','风险综合评级错误结果信息')">导出</a>
    </div>
</body>
<script  type="text/javascript">
//ok
function ok(){	
	...
	$('#uploadForm').form('submit',{	
		url: '${pageContext.request.contextPath}/lianghuaupload/upload.do',		
 		onSubmit: function(){
 			type = 0;
 			return checkinput();
 		},
...
function modedownload(param){	
	...
	$.post('${pageContext.request.contextPath}/lianghuaupload/modedownload.do',data,function(result){ 
		//$.post('${pageContext.request.contextPath}/uploadFiles/downloadFilebill.do',data,function(result){
		if (result.success){
...
function Uploader(chunk,_data, year,quarter ,reportId,reportname,reporttype, callBack){
	...
	upladoer.attr({'src':'<%=basePath%>page/zcfzlianghuaInfo/multiupload.jsp?chunk2='+ chunk + '&' + _data,width:'100%',height:'100%',frameborder:'0',scrolling:'no'});
	addWin.window({
		title:"上传文件",
		height:370,
		width:550,
