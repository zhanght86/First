...
function Uploader(chunk,callBack){
	...
	var upladoer = $('<iframe/>');
	upladoer.attr({'src':'<%=basePath%>/page/system/uploader.jsp?chunk='+chunk,width:'100%',height:'100%',frameborder:'0',scrolling:'no'});
	addWin.window({
		title:"上传文件",
		height:350,
		width:550,
