...
<!-- 搜索模块 -->
	<div class="easyui-panel"  style="padding: 10px;width: 100%" data-options="footer:'#ft'">		
		...
		<input type="hidden" name="department" value="03">
...
function ok(){	
	...
	var url='${pageContext.request.contextPath}/RiskDataImport/upload.do';
...
function modedownload(modeltype){
	...
	var data =[{name:'department',value:'03'},{name:'modelType',value:modeltype},{name:'reportId',value:rows[0].reportId },{name:'yearmonth',value:rows[0].year},{name:'quarter',value:rows[0].quarter},{name:'reporttype',value:rows[0].reportType },{name:'reportname',value:rows[0].reportCategory }];
