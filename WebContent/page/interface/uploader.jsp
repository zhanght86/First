...
var year = eval('${param.year}'); //获取页面文本框中的值
var quarter = eval('${param.quarter}');
var yearmonth = eval('${param.yearmonth}');
//var impdate = eval('${param.impdate}');
var impdate = theRequst["impdate"];
var data = "?year="+year+"&quarter="+quarter+"&yearmonth="+yearmonth+"&impdate="+impdate;
//alert(data);
$("#uploader").pluploadQueue($.extend({
	runtimes : 'html5,flash,html4',
	url : '${pageContext.request.contextPath}/cux_sino/multiupload.do' +  data,
	...
	init:{
		...
		UploadComplete:function(uploader,fs){
			...
			alert("上传完成！共"+fs.length+"个。成功"+files.length + "个" +e);
			target.window("close");
		}
	}
