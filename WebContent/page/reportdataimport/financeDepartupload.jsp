...
var data = "?year="+year+"&quarter="+quarter +"&reportId="+reportId+"&department="+department+"&interfacetype="+reportname+"&reporttype="+reporttype;
//var interfacetype=reporttype;
//alert(data);
$("#uploader").pluploadQueue($.extend({
	runtimes : 'html5,flash,html4',
	url : '${pageContext.request.contextPath}/InterDeal/impFinanceData.do'+  data,
