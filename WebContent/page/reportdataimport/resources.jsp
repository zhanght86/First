		...
		data-options="
			...
			<thead>
				<tr>
					...
					<th field="reportId" width="45" >报送号</th>
...
function modedownload(modeltype){
	...
	var data =[{name:'department',value:'04'},{name:'modelType',value:modeltype},{name:'reportId',value:rows[0].reportId },{name:'yearmonth',value:rows[0].year},{name:'quarter',value:rows[0].quarter},{name:'reporttype',value:rows[0].reportType },{name:'reportname',value:rows[0].reportCategory},{name:'currDate',value:currDate}];
...
function makerUpload(chunk){
	...
	var _data = 'department=04&year=' + year + '&quarter=' + quarter +'&reportId=' + reportId+'&reportname='+reportname+'&reporttype='+reporttype ;
	//alert(_data);
